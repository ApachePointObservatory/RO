...
"""
__all__ = ["TkSocket", "TkServerSocket", "BaseServer"]
...
class TkBaseSocket(BaseSocket):
    """A basic TCP/IP socket using Tk sockets.
    ...
    def __str__(self):
        return "%s(addr=%r, port=%r)" % (self.__class__.__name__, self._addr, self._port)
